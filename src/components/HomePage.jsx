    ...
    <div className="px-8 mt-10">
        ...
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              ...
              <p className="font-semibold text-sm md:text-lg lg:text-xl">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between items-center mb-[20px]">
        <h2 className="text-2xl md:text-3xl font-bold text-center">
          Top 10 Cryptocurrencies Stats
        </h2>
        <Link
          to="/cryptocurrencies"
          className="text-[#1677ff] font-bold text-xl md:text-2xl flex md:flex"
        >
          Show More
        </Link>
      </div>
      ...
      <div className="flex justify-between items-center mb-[20px]">
        ...
        <Link
          to="/news"
          className="text-[#1677ff] font-bold text-xl md:text-2xl"
        >
          Show More
        </Link>
      </div>
